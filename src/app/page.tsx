...
export default function HomePage() {
  return (
    <div className="flex w-full flex-1 flex-col">
      ...
      <main className="mx-auto flex w-full max-w-6xl flex-1 flex-col gap-14 px-6 py-14">
        {/* --- Hero ------------------------------------------------------- */}
        <header className="flex flex-col gap-7">
          <span className="chip w-fit">
            <ScanLine className="h-3.5 w-3.5 text-[var(--accent)]" />
            The diagnostic for B2A commerce
          </span>

          <h1 className="max-w-4xl font-display text-5xl font-bold leading-[1.05] tracking-tight text-[var(--ink)] sm:text-6xl">
            Is your brand{" "}
          ...
          <p className="max-w-3xl text-lg leading-relaxed text-[var(--ink-soft)]">
            AgentReady scores any brand against the 8-dimension{" "}
            <strong className="font-semibold text-[var(--ink)]">ACX Index</strong>,
        ...
        {STATIC_MODE ? (
          <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[rgba(124,92,255,0.06)] p-6">
            ...
            <p className="mt-2 max-w-3xl text-sm leading-relaxed text-[var(--ink-soft)]">
              ...
              diagnostic: probe sweep → multi-agent shopping panel → 8-dimension scoring →
              board-ready scorecard, reproduced from recorded evidence.
            </p>
          </div>
        ) : null}
        ...
        <footer className="mt-auto flex flex-col gap-2 border-t border-[var(--border)] pt-6 text-xs text-[var(--ink-faint)]">
